	...
	<div class="order-2 lg:order-1">
		<div class="rounded-3xl bg-white p-8 shadow-xl ring-1 ring-zinc-200 sm:p-12">
			...
			<form on:submit={handleSubmit} class="mt-8 space-y-6">
				...
				<div>
					<label for="company" class="block text-sm font-medium text-zinc-900">Azienda *</label>
					<input
						type="text"
						id="company"
				...
				{#if submitStatus === 'error'}
					<div class="rounded-lg bg-red-50 p-4 text-sm text-red-600" transition:fade={{ duration: 200 }}>
	...
	<div class="order-1 lg:order-2">
		<div class="rounded-3xl bg-zinc-900 p-8 text-white sm:p-12">
			...
			<div class="mt-6 space-y-6 text-zinc-300">
				<p>
					Sono sempre entusiasta di conoscere nuove persone e aiutarle a raggiungere i loro obiettivi di
					movimento e benessere.
				</p>
				<p>
					Non importa se sei un principiante assoluto o un atleta esperto - insieme possiamo creare un
					percorso personalizzato che si adatti perfettamente alle tue esigenze.
				</p>
				<p>
