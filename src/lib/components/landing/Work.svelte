...
<section class="scroll-mt-24" id="work">
  <div class="px-8 md:px-12 py-24 max-w-2xl mx-auto">
    <h2 class="text-xl tracking-tighter font-light text-black">
      Qualche foto dagli allenamenti.
    </h2>
    ...
    >
      <div
        class="flex flex-col w-full bg-white rounded-3xl pt-4 mt-4"
      ...
      >
        ...
        >
          ...
          >
            <Image src="/bernini/parkour.jpg" alt="" width={400} height={400} />
          </div>
          <div
            class="items-center justify-center w-full flex flex-col shrink-0 snap-start"
            role="option"
          ...
          shrink-0 snap-start"
            ...
            x-bind="disableNextAndPreviousButtons"
          >
            <Image src="/bernini/parkour.jpg" alt="" width={400} height={290} />
          </div>
        </div>
      </div>
    </div>
