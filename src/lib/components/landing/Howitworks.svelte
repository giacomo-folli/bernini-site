<section class="scroll-mt-12" id="how">
	<div class="mx-auto max-w-2xl px-8 py-12 md:px-12">
		...
		<div class="mt-8 flex flex-col gap-2 text-pretty text-sm text-zinc-500">
			<p>
				Il mio metodo di allenamento è basato su un approccio personalizzato e multidisciplinare.
				Iniziamo con una <span class="font-semibold">valutazione </span> approfondita dei tuoi
