				...
				<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 lg:grid-cols-4 lg:gap-8">
					{#each courses as course, i}
						<div
							...
							class="group relative overflow-hidden rounded-2xl bg-white p-4 shadow-xl ring-1 ring-zinc-200 transition-all duration-300 hover:shadow-2xl sm:rounded-3xl sm:p-6"
						>
